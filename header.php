...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo get_theme_file_uri() . '/assets/images/favicon.png' ?>">
                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-flex">
                            <div class="logo-menu-wrap">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="<?php echo get_theme_file_uri() . '/assets/images/logo/logo-9.png'?>" alt="logo">
                                    </a>
                                </div>
                                                ...
                                                <ul class="mega-menu-style-1 mega-menu-width2 menu-negative-mrg2">
                                                    ...
                                                    <li class="mega-menu-sub-width40">
                                                        <div class="banner-menu-content-wrap default-overlay">
                                                            <a href="product-details.html"><img src="<?php echo get_theme_file_uri() . '/assets/images/menu/banner-header-1.jpg'?>" alt="banner"></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-6">
                            <div class="mobile-logo mobile-logo-width">
                                <a href="index.html">
                                    <img alt="" src="<?php echo get_theme_file_uri() . '/assets/images/logo/logo-9.png'?>">
                                </a>
                            </div>
                        </div>
                        <div class="col-6">
