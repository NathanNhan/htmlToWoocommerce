                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="footer-widget mb-40">
                                ...
                                <div class="app-google-store">
                                    <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/app-store.png' ?>" alt=""></a>
                                    <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/google-play.png'?>" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-bottom border-top-1">
                <div class="container">
                    <div class="copyright copyright-ptb text-center">
                        <p>Copyright © 2023 Dking - <a target="_blank" href="https://hasthemes.com/"> All Right Reserved</a></p>
                    </div>
                </div>
            </div>
        </footer>
