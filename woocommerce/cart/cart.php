		...
		<tbody>
			...
			<tr>
				<td colspan="6" class="actions">
						...
						<button type="submit" id="update_cart_button" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>" disabled=""><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
