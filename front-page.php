<?php get_header(); ?> 
                    ...
                    <div class="col-lg-9">
                        <div class="slider-area mr-15">
                            <div class="slider-active-5 dot-style-6 dot-style-6-position-1">
                                <div class="single-slider slider-height-13 custom-d-flex custom-align-item-center bg-img" style="background-image:url(<?php echo get_theme_file_uri() . '/assets/images/slider/mega-fashion-1-1.jpg'?>);">
                                    <div class="container">
                                ...
                                <div class="single-slider slider-height-13 custom-d-flex custom-align-item-center bg-img" style="background-image:url(<?php echo get_theme_file_uri() . '/assets/images/slider/mega-fashion-1-2.jpg'?>);">
                                    <div class="container">
                                        <div class="slider-content-12 slider-animated-1">
                                            <h1 class="animated">Build <br><span class="bold">E-commerce</span> <br><span class="blue">Mega</span> Store</h1>
                                            <p class="animated">Seamlessly predominate enterprise metrics without performance based process </p>
                                ...
                                <div class="single-slider slider-height-13 custom-d-flex custom-align-item-center bg-img" style="background-image:url(<?php echo get_theme_file_uri() . '/assets/images/slider/mega-fashion-1-3.jpg'?>);">
                                    <div class="container">
                                        <div class="slider-content-12 slider-animated-1">
                                            <h1 class="animated">Build <br><span class="bold">E-commerce</span> <br><span class="blue">Mega</span> Store</h1>
                                            <p class="animated">Seamlessly predominate enterprise metrics without performance based process </p>
                    ...
                    <div class="col-lg-3">
                        <div class="banner-wrap ml-15">
                            <div class="banner-img fix">
                                <a href="product-details.html"><img src="<?php echo get_theme_file_uri() . '/assets/images/banner/banner-54.jpg'?>" alt="banner"></a>
                            </div>
                            ...
                            <div class="banner-btn-4 black text-center mega-fashion1-banner-btn">
                                <a href="shop.html">Browse Store <img class="inject-me" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/right-arrow-banner-2.svg'?>" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="offer-product-wrap mr-60">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-132.jpg'?>" alt="">
                                </a>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-lg-12 col-md-6">
                                <div class="service-wrap-3 mb-85">
                                    <div class="service-img-3">
                                        <img class="inject-me" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/happiness.svg'?>" alt="">
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="service-wrap-3 mb-85">
                                    <div class="service-img-3">
                                        <img class="inject-me" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/shipping-car.svg'?>" alt="">
                                    </div>
                                    <div class="service-content-3">
                                        <h3>Free Shipping </h3>
                                        <p>Free Shipping for any product and it's world wide</p>
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="service-wrap-3 mb-85">
                                    <div class="service-img-3">
                                        <img class="inject-me" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/support-expart.svg'?>" alt="">
                                    </div>
                                    <div class="service-content-3">
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="service-wrap-3 mb-85">
                                    <div class="service-img-3">
                                        <img class="inject-me" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/trusty.svg'?>" alt="">
                                    </div>
                                    <div class="service-content-3">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="offer-product-wrap">
                            ...
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-133.jpg'?>" alt="">
                                </a>
                                <div class="title-timer product-timer-3 text-center">
                                    ...
                                    <div class="banner-btn-4 black">
                                        <a href="shop.html">Browse Store <img class="inject-me arrow-mrg-dec" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/right-arrow-banner-2.svg'?>" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="product-wrap mb-50">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-134.jpg'?>" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="product-wrap mb-50">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-135.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="product-wrap mb-50">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-136.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="product-wrap mb-50">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-137.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="product-wrap mb-50">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-138.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="product-wrap mb-50">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-139.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-5 col-lg-12">
                                    <div class="banner-img-2 banner-img-2-mrg1">
                                        <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/banner/banner-55.jpg'?>" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-5 col-lg-12">
                                    <div class="banner-img-2 banner-img-2-mrg2">
                                        <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/banner/banner-56.jpg'?>" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="banner-btn-4 black-2 banner-btn-4-right banner-btn-4-mrg-none">
                            <a href="shop.html">Browse All Products <img class="inject-me arrow-mrg-dec" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/right-arrow-banner-2.svg'?>" alt=""></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-140.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-141.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-142.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-143.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-144.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-145.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-146.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-147.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-148.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-149.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                                <div class="product-wrap mb-40">
                                    <div class="product-img product-img-zoom mb-25">
                                        <a href="product-details.html">
                                            <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-150.jpg'?>" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <h4><a href="product-details.html">Product Title</a></h4>
                ...
                <div class="product-slider-active-4">
                    <div class="product-wrap-plr-1">
                        <div class="product-wrap">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-151.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                                <h4><a href="product-details.html">Product Title</a></h4>
                    ...
                    <div class="product-wrap-plr-1">
                        <div class="product-wrap">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-152.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                                <h4><a href="product-details.html">Product Title</a></h4>
                    ...
                    <div class="product-wrap-plr-1">
                        <div class="product-wrap">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-153.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                                <h4><a href="product-details.html">Product Title</a></h4>
                    ...
                    <div class="product-wrap-plr-1">
                        <div class="product-wrap">
                            <div class="product-img product-img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="<?php echo get_theme_file_uri() . '/assets/images/product/product-154.jpg'?>" alt="">
                                </a>
                            </div>
                            <div class="product-content">
                                <h4><a href="product-details.html">Product Title</a></h4>
        ...
        <div class="about-area bg-img mega-fashion-bg-img pt-90 pb-130" style="background-image:url(<?php echo get_theme_file_uri() . '/assets/images/bg/bg-10.jpg'?>);">
            <div class="container">
            ...
            <div class="fashion1-polygon"><img src="<?php echo get_theme_file_uri() . '/assets/images/about/fashion1-polygon.png'?>" alt=""></div>
            ...
            <div class="container">
                <div class="mb-65">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="banner-btn-4 black-2 banner-btn-4-right banner-btn-4-mrg-none">
                                <a href="#">Browse All Brand <img class="inject-me arrow-mrg-dec" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/right-arrow-banner-2.svg'?>" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-27.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-28.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-29.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-30.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-31.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-32.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-1.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-2.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-3.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-4.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-5.png'?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <div class="single-brand-logo-4 mb-70">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/brand-logo/brand-logo-6.png'?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-12 position-relative">
                        <div class="testimonial-3-content-area">
                            ...
                            <div class="testimonials-3-btn">
                                <a href="product-details.html">All Testimonials <img class="inject-me" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/arrow-right.svg' ?>" alt=""></a>
                            </div>
                        </div>
                        <div class="testimonial-next-img">
                            <img src="<?php echo get_theme_file_uri() . '/assets/images/testimonial/testimonial-img-2.png '?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-7 col-sm-12 col-12 me-auto">
                        <div class="testimonial-img-slider-active-3">
                            <div class="testimonial-img-slider">
                                <img src="<?php echo get_theme_file_uri() . '/assets/images/testimonial/testimonial-img-17.jpg' ?>" alt="">
                                <div class="testimonial-img-slider-icon">
                                    <img class="inject-me icon-black" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/quotes-icon-2.svg'?>" alt="">
                                </div>
                            </div>
                            <div class="testimonial-img-slider">
                                <img src="<?php echo get_theme_file_uri() . '/assets/images/testimonial/testimonial-img-18.jpg' ?>" alt="">
                                <div class="testimonial-img-slider-icon">
                                    <img class="inject-me icon-black" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/quotes-icon-2.svg'?>" alt="">
                                </div>
                            </div>
                            <div class="testimonial-img-slider">
                                <img src="<?php echo get_theme_file_uri() . '/assets/images/testimonial/testimonial-img-1.jpg"' ?> alt="">
                                <div class="testimonial-img-slider-icon">
                                    <img class="inject-me icon-black" src="<?php echo get_theme_file_uri() . '/assets/images/icon-img/quotes-icon-2.svg'?>" alt="">
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="blog-wrap mb-30">
                            <div class="blog-img mb-35">
                                <a href="blog-details.html"><img src="<?php echo get_theme_file_uri() . '/assets/images/blog/blog-10.jpg'?>" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="blog-wrap mb-30">
                            <div class="blog-img mb-35">
                                <a href="blog-details.html"><img src="<?php echo get_theme_file_uri() . '/assets/images/blog/blog-11.jpg'?>" alt=""></a>
                            </div>
                            <div class="blog-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="blog-wrap mb-30">
                            <div class="blog-img mb-35">
                                <a href="blog-details.html"><img src="<?php echo get_theme_file_uri() . '/assets/images/blog/blog-12.jpg'?>" alt=""></a>
                            </div>
                            <div class="blog-content">
                ...
                <div class="row grid">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 grid-item">
                        <div class="single-instafeed mb-30">
                            <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/instafeed/instafeed-36.jpg'?>" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 grid-item">
                        <div class="single-instafeed mb-30">
                            <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/instafeed/instafeed-37.jpg'?>" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 grid-item">
                        <div class="single-instafeed mb-30">
                            <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/instafeed/instafeed-38.jpg'?>" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 grid-item">
                        <div class="single-instafeed mb-30">
                            <a href="#"><img src="<?php echo get_theme_file_uri() . '/assets/images/instafeed/instafeed-39.jpg'?>" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
